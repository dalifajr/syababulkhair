...
import type { TeachingAssignment } from '@/types/academic';

type Props = {
    teachingAssignments: TeachingAssignment[];
};

export default function ScheduleCreate({ teachingAssignments }: Props) {
    ...
    return (
        <AppLayout title="Tambah Jadwal" showBack={true} backUrl="/admin/schedules">
