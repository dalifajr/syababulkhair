...
export default function AchievementPostEdit({ post: achievementPost }: Props) {
    const [preview, setPreview] = useState<string | null>(`/storage/${achievementPost.image_path}`);
    const { data, setData, processing, errors, progress } = useForm({
        ...
        event_date: achievementPost.event_date.split('T')[0],
        is_published: achievementPost.is_published,
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        router.post(`/admin/achievement-posts/${achievementPost.id}`, {
            ...data,
            _method: 'put',
        }, {
            forceFormData: true,
    ...
    return (
        <AppLayout title="Edit Prestasi" showBack={true} backUrl="/admin/achievement-posts">
            <Head title="Edit Prestasi Membanggakan" />
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            placeholder="Deskripsi tentang prestasi yang diraih..."
                            rows={4}
