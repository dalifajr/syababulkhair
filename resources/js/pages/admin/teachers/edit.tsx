...
export default function TeacherEdit({ teacher }: Props) {
    ...
    return (
        <AppLayout title="Edit Guru" showBack={true} backUrl="/admin/teachers">
            <Head title="Edit Guru/Staff" />
            ...
            <div className="m3-container py-6">
                <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-6">
                    <div className="m3-card-elevated space-y-5">
                        ...
                        <div>
                            <label className="text-sm font-medium text-on-surface-variant">Password Baru (opsional)</label>
                            <input
                                type="password"
                                value={data.password}
