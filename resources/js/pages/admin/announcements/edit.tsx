...
export default function AnnouncementEdit({ announcement }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        type: (announcement.type || 'general') as keyof typeof ANNOUNCEMENT_TYPES,
        target_audience: (announcement.target_audience || 'all') as keyof typeof ANNOUNCEMENT_AUDIENCES,
    ...
    return (
        <AppLayout title="Edit Pengumuman" showBack={true} backUrl="/admin/announcements">
