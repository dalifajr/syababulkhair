...
export default function BehavioralNoteEdit({ note, students }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/behavioral-notes/${note.id}`);
    };

    return (
        <AppLayout title="Edit Catatan Perilaku" showBack={true} backUrl="/admin/behavioral-notes">
            <Head title="Edit Catatan Perilaku" />
